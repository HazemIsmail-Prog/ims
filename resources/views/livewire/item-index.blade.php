        ...
        @forelse ($items as $item)
            <div
                ...
                <div class=" flex flex-col flex-1 space-y-2 justify-start">
                    ...
                    <div>
                        <span
                            class="bg-green-100 text-green-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-green-900 dark:text-green-300">{{ __('messages.available') }} : {{ $item->available_quantity }}</span>
                    </div>
                    <div>
                        <span
                            class="bg-red-100 text-red-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-red-900 dark:text-red-300">{{ __('messages.deprecated') }} : {{ $item->deprecated_quantity }}</span>
                    </div>
