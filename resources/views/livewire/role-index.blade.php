<x-slot name="header">
    <div class=" flex items-center justify-between">
        ...
        @can('roles_create')
            <x-button x-data="{}" x-on:click="window.livewire.emitTo('role-form','showingModal',null)"
                wire:loading.attr="disabled" class="py-0.5">{{ __('messages.add_role') }}</x-button>
        @endcan
    </div>
</x-slot>


<div class="p-6 lg:lg-8 {{ $roles->hasPages() ? 'mb-10' : '' }}">
    @livewire('role-form')
    ...
    <div class="sm:rounded-lg">
        <div class="flex items-center justify-between py-4 bg-white dark:bg-gray-800">
            <div class="relative">
                ...
                <input wire:model="search" type="text" id="table-search-roles"
            ...
            <div
                ...
                <div class=" text-end">
                    <div class="flex gap-3 justify-end">
                        @can('roles_edit')
                            <button x-data="{}"
                                x-on:click="window.livewire.emitTo('role-form','showingModal',{{ $role->id }})">
                                <x-svgs.edit />
                            </button>
                        @endcan
                        @can('roles_delete')
